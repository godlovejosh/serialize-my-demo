package serialize.entity.model;
...
public class TradeDO implements Serializable {
    ...
    private static final long serialVersionUID = 9105622502372566767L;
    // ID
    private Long id;
    // 物流交易号
    ...
    // 已核销金额
    private BigDecimal verifyAmount = new BigDecimal(0);
    // 未核销金额
    private BigDecimal unverifyAmount = new BigDecimal(0);
    // 折扣单号
    private String discountBillNo;
    // 事前折扣金额
    private BigDecimal discountAmount = new BigDecimal(0);
    // 事后折扣金额
    private BigDecimal postDiscountAmount = new BigDecimal(0);
    // 应收付单号
    ...
    // 6%已开票金额
    private BigDecimal invoiceLiAmount = new BigDecimal(0);
    // 运输收入
    private BigDecimal transportIncome = new BigDecimal(0);
    // 物流辅助收入
    private BigDecimal logisticsIncome = new BigDecimal(0);
    // 不含税运输收入
    private BigDecimal transportIncomeNoTax = new BigDecimal(0);
    // 不含税物流辅助收入
    private BigDecimal logisticsIncomeNoTax = new BigDecimal(0);
    // 运输收入税额
    private BigDecimal transportIncomeTax = new BigDecimal(0);
    // 物流辅助收入税额
    private BigDecimal logisticsIncomeTax = new BigDecimal(0);
    // 创建人工号
