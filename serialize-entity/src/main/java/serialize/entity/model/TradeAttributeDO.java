...
public class TradeAttributeDO implements Serializable {
	...
	public String toString() {
		return "TradeAttributeDO [origOrgName=" + origOrgName + ", origOrgCode=" + origOrgCode + ", origOrgUnifiedCode="
				...
				+ ", errorType=" + errorType + ", feeType=" + feeType + ", customerPhone=" + customerPhone
				...
				+ billType + ", mistakeNum=" + mistakeNum + ", badDebtReason=" + badDebtReason + "]";
	}
